...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('d194aa11f305efea5c6b88b8a943c720426827b3'))) && false ?: '_'}, '/_fragment');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/CsvParserBundle/Resources/views'), 'CsvParser');
        $instance->addPath(($this->targetDirs[3].'/src/CsvParserBundle/Resources/views'), '!CsvParser');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('d194aa11f305efea5c6b88b8a943c720426827b3');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'CsvParserBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/CsvParserBundle'),
                    'namespace' => 'CsvParserBundle',
                ],
                'DebugBundle' => [
                    'parent' => NULL,
            ...
            case 'csv_upload_dir': $value = ($this->targetDirs[3].'/app/../web/assets/csv'); break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'CsvParserBundle' => 'CsvParserBundle\\CsvParserBundle',
            ...
            'secret' => 'd194aa11f305efea5c6b88b8a943c720426827b3',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => '',
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'd194aa11f305efea5c6b88b8a943c720426827b3',
